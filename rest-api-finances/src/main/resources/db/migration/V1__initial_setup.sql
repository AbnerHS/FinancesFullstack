...
(
    ...
    total        number(38,2),
    data_pedido  timestamp(9),
    status       varchar2(20 char),
    cliente_nome varchar2(150 char) not null,
    primary key (id)
);
...
(
    id             number(19,0) generated by default as identity,
    preco_unitario number(38,2) not null,
    quantidade     number(10,0) not null,
    pedido_id      number(19,0) not null,
    produto_nome   varchar2(150 char) not null,
    primary key (id)
);
...
alter table itens_pedido
    add constraint fk_item_pedido foreign key (pedido_id) references pedidos;